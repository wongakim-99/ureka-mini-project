...
public class CustomerUpdateFrame extends JFrame {
	...
	protected JTextField tfName, tfPhone, tfEmail, tfAge;
	...
	public CustomerUpdateFrame() {
		...
		tfEmail = new JTextField(); tfAge = new JTextField();
		btnUpdate = new JButton("수정"); btnDelete = new JButton("삭제"); btnCancel = new JButton("취소");
		makeGui();
	}

	private void makeGui() {
		setTitle("고객 수정/삭제"); setSize(450, 280);
		add(panInsert, BorderLayout.CENTER); panInsert.setLayout(null);
		JLabel lName = new JLabel("이름"); JLabel lPhone = new JLabel("전화번호");
		JLabel lEmail = new JLabel("이메일"); JLabel lAge = new JLabel("나이");
		...
		panInsert.add(lAge);   lAge.setBounds(10, 140, 70, 30);
		...
		panInsert.add(tfAge);   tfAge.setBounds(90, 140, 80, 30);
