...
public class ScreeningInsFrm extends JFrame {
	...
	public ScreeningInsFrm() {
		...
		tfShowtime = new JTextField(); tfPrice = new JTextField();
		btnSave = new JButton("저장"); btnCancel = new JButton("취소");
		makeGui();
	}

	private void makeGui() {
		setTitle("상영일정 추가"); setSize(520, 280);
		...
		JLabel lH = new JLabel("※ 상영시간 형식: 2026-05-20 14:00:00");
		...
		panInsert.add(lH); lH.setBounds(90, 170, 380, 20);
