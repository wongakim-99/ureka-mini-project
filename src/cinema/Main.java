...
public class Main {
	...
	// =====================
	private ReservListPan reservListPan;
	private ReservInsFrm reservInsFrm;
	private ReservUpFrm reservUpFrm;
	private ReservControl reservControl;

	public Main() {
		frm  = new JFrame("영화 예약 관리 시스템");
		card = new CardLayout();
		// =====================
		menuBar          = new MenuBar();
		menu1            = new Menu("메 뉴");
		menuItemMovie     = new MenuItem("영화 관리");
		menuItemTheater   = new MenuItem("상영관 관리");
		menuItemScreening = new MenuItem("상영일정 관리");
		menuItemCust      = new MenuItem("고객 관리");
		menuItemResrv     = new MenuItem("예약 관리");
		// =====================
		dialog         = new JDialog(frm, "알림창", true);
		dialogLabel    = new JLabel("");
		btnDialogClose = new JButton("닫기");
		// =====================
		movieListPan    = new MovieListPan();
		movieInsFrm     = new MovieInsFrm();
		movieUpFrm      = new MovieUpFrm();
		// =====================
		theaterListPan  = new TheaterListPan();
		theaterInsFrm   = new TheaterInsFrm();
		theaterUpFrm    = new TheaterUpFrm();
		// =====================
		screeningListPan = new ScreeningListPan();
		screeningInsFrm  = new ScreeningInsFrm();
		screeningUpFrm   = new ScreeningUpFrm();
		// =====================
		custListPan     = new CustListPan();
		custInsFrm      = new CustInsFrm();
		custUpFrm       = new CustUpFrm();
		// =====================
		reservListPan   = new ReservListPan();
		reservInsFrm    = new ReservInsFrm();
		reservUpFrm     = new ReservUpFrm();
	}
	...
	private void makeGui() {
		...
		menuBar.add(menu1);
		menu1.add(menuItemMovie);      menu1.addSeparator();
		menu1.add(menuItemTheater);    menu1.addSeparator();
		menu1.add(menuItemScreening);  menu1.addSeparator();
		...
		// =====================
		frm.setLayout(card);
		frm.add(movieListPan,    "MovieList");
		frm.add(theaterListPan,  "TheaterList");
		frm.add(screeningListPan,"ScreenList");
	...
	private void addEvent() {
		...
		menuItemMovie.addActionListener(menuControl);
		menuItemTheater.addActionListener(menuControl);
		menuItemScreening.addActionListener(menuControl);
		...
		movieListPan.addEvent(movieControl);
		movieInsFrm.addEvent(movieControl);
		movieUpFrm.addEvent(movieControl);
		// =====================
		theaterControl = new TheaterControl(dialog, dialogLabel);
		theaterListPan.addEvent(theaterControl);
		theaterInsFrm.addEvent(theaterControl);
		theaterUpFrm.addEvent(theaterControl);
		// =====================
		screeningControl = new ScreeningControl(dialog, dialogLabel);
		screeningListPan.addEvent(screeningControl);
		screeningInsFrm.addEvent(screeningControl);
		screeningUpFrm.addEvent(screeningControl);
		// =====================
		...
		reservListPan.addEvent(reservControl);
		reservInsFrm.addEvent(reservControl);
		reservUpFrm.addEvent(reservControl);
	}
